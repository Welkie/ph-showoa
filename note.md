...
Tối ưu hóa tensor các điểm chưa tốt hoặc cải tiến các điểm chưa tốt để nâng cao kết quả, kết quả
về mặt thời gian thì vẫn nhanh hơn nhưng chạy vẫn còn tệ về performance. Phải ưu tiên NV trước rồi sau đó đến TD. lẽ ra phải tốt về NV và TD như bản src_cpp_hybrid_SA_RCRS_GRASP (tham khảo ý tưởng, logic, mọi thứ) khác là bản đó chạy hybrid(cpu+gpu), còn tui muốn là full gpu
